 ...
 * @since 3.0
 */
function cerber_blocked_num():int {
    return (int) cerber_db_get_var( 'SELECT count(ip) FROM ' . CERBER_BLOCKS_TABLE );
}
...
function cerber_push_the_news() {
	...
	$text .= '<p style="text-align:right; padding-right: 20px;">
    		    <input type="button" class="button button-primary crb-dismiss-trigger" data-crb-context="new_release_announcement" value=" &nbsp; ' . __( 'Awesome!', 'wp-cerber' ) . ' &nbsp; "/></p>';
